...
export default function ListWarehouseInfo() {
  ...
  const [formData, setFormData] = useState<WarehouseInfoFormSchema>();
  ...
  const onSubmit = (data: WarehouseInfoFormSchema) => {
        ...
        <div className="flex flex-col gap-2 border border-steel-shadow rounded-lg p-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-[30%]">
              <SelectInput
                label="Estado*"
                defaultOption={states.find((state) => state.value === formData?.address?.state)}
                options={states}
          ...
          <div className="flex gap-4">
            <div className="w-[50%]">
              <TextInput
                ...
                maxLength={100}
                register={register("")}
                errorMessage={errors.socials?.[2]?.value?.message}
              />
            </div>
            <div className="w-[50%]">
              <TextInput
                ...
                className="overflow-hidden"
                maxLength={100}
                register={register("socials.1.platform")}
              />
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-[50%]">
              <TextInput
                ...
                className="overflow-hidden"
                maxLength={100}
                register={register("socials.2.platform")}
              />
            </div>
            <div className="w-[50%]">
              <TextInput
          ...
          <div className="flex gap-4">
            <div className="w-[50%]">
              <TextInput
                ...
                className="overflow-hidden"
                maxLength={100}
                register={register("socials.3.platform")}
              />
            </div>
            <div className="w-[50%]">
              <TextInput
                ...
                className="overflow-hidden"
                maxLength={100}
                register={register("socials.4.platform")}
              />
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-[50%]">
              <TextInput
                ...
                className="overflow-hidden"
                maxLength={100}
                register={register("socials.5.platform")}
              />
            </div>
            <div className="w-[50%]">
              <TextInput
                ...
                className="overflow-hidden"
                maxLength={100}
                register={register("socials.6.platform")}
              />
            </div>
          </div>
        </div>
