...
export default function sendTelegram() {
  ...
  useEffect(() => {
    ...
    cart.forEach((productCart) => {
      const price = productCart.offer.product.pricing === "UNIT" ? productCart.offer.subtotal : productCart.offer.subtotal * 0.5;
  ...
  const sendData = async () => {
    ...
    const purchase = {
      products: cart.map((productCart) => ({
        ...
        price: productCart.offer.product.pricing === "UNIT" ? productCart.offer.subtotal : productCart.offer.subtotal * 0.5,
